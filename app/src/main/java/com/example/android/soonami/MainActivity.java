    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                // check wheather it has valid response http code or not
                ...
                {
                    Log.e(LOG_TAG,"response code is not 200 it is "+urlConnection.getResponseCode());
                }

                // if code is not 200 then jsonResponse will be empty string and by exception null will be returnedf

            } catch (IOException e)
            {
               Log.e(LOG_TAG,"THE IOEXCEPTION HAS BEEN CAUGHT",e);
            } finally
            {
